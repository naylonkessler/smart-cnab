...
class FileSICOOBTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSpecialCharactersTransliterate() {
        ...
        $this->assertEquals('teste c .                     0000000000', $details[1]['name']);
    }
